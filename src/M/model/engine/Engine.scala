...
object Engine {
  ...
  def computePotentialLocation(obj: PhysicalObject, dt: Double): EngineVec = {
    ...
    new EngineVec(newX, newY, newZ)
  }

  def updateVelocity(obj: PhysicalObject, world: Arena, dt: Double): Unit = {
...
//      Double.PositiveInfinity
  ...
  def yIntercept(p1: EngineVec, m: Double): Double = {
    p1.y - m * p1.x
  }

  def detectCollision(obj: PhysicalObject, potentialLocation: EngineVec, boundary: Boundary): Boolean = {
